...
class StackViewsRemoteFactory implements RemoteViewsService.RemoteViewsFactory {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        RemoteViews remoteViews = new RemoteViews(mContext.getPackageName(), R.layout.widget_list_items);
        ...
        if (mRecipes == null) {
            ...
            try {
                ...
                if (urlConnection.getResponseCode() == 200) {
                    ...
                    Recipe[] recipeArray = new Gson().fromJson(inputStream, Recipe[].class);
